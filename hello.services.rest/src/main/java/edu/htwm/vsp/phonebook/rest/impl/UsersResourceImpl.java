...
import edu.htwm.vsp.phonebook.rest.PhoneResource;

@RequestScoped
public class UsersResourceImpl implements PhoneResource {
	...
	public Response createUser(UriInfo uriInfo, String name) {
		...
		URI created = absolutePathBuilder.path(PhoneResource.class, "getUser").build(newUser.getId());
